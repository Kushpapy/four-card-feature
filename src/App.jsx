...
const FeatureBox = styled.div`
  ...
  padding: 1.2rem;
  border-radius: 5px;
  border-top: 5px solid var(${({ $borderColor }) => $borderColor});
  display: flex;
    ...
    <StyledApp>
      <TitleBox>
        <p>
          ...
          <span>Powered by Technology Our Artificial</span>
        </p>
      </TitleBox>
      <TextBox>
        Intelligence powered tools use millions of project data <br /> points to
        ensure that your project is successful
      </TextBox>
      <ContentBox>
        <FeatureBox $borderColor="--Cyan">
          <div>
            <H2>Supervisor</H2>
            <p>
        ...
        <SpecialContainer>
          <FeatureBox $borderColor="--Red">
            <div>
              <H2>Team Builder</H2>
              <p>
                Scans our talent network to create the <br /> optimal team for
                your project
              </p>
            </div>
            <SvgBox>
